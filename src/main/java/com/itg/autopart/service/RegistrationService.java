...
import com.itg.autopart.rules.EmailValidator;
...
public class RegistrationService {
    ...
    public String register(CreateUserRequest createUserRequest) {
        ...
        log.info("register confirmation token...");
        ...
        String token = userSecurityService.signUpUser(user);

        String link = "http://localhost:8080/api/v1/registration/confirm?token=" + token;

        emailSender.sendConfirmEmail(createUserRequest.getEmail(),
                buildEmail(createUserRequest.getName(), link));
    ...
    public String confirmToken(String token) {
        log.info("going to confirmation ...");
        ...
        userSecurityService.enableAppUser(
